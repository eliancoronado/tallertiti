...
const Delivery = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.vehicleType || !formData.licensePlate || !formData.situation || !formData.address) {
        setError('Todos los campos son requeridos.');
        return;
    }

    try {
        const response = await axios.post('http://localhost:4000/api/auth/solicitud', {
